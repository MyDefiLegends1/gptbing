...
export default {
  ...
  com_ui_capabilities: 'How to Use?',
  com_ui_capability_remember: 'Click the green image below and select ChatGPT',
  com_ui_capability_correction: 'If error just click the blue image in the menu',
  com_ui_capability_decline_requests: 'Join us on telegram at bingblong ai for questions',
